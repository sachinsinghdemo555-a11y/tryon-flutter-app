                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [BoxShadow(color: AppConstants.goldColor.withOpacity(0.3), blurRadius: 20, spreadRadius: 4)],
                      ),
                      child: const Center(child: Text('💎', style: TextStyle(fontSize: 54))),
                    ),
                    const SizedBox(height: 28),
                    Text('Jewellery TryOn',
                        style: GoogleFonts.playfairDisplay(color: Colors.white, fontSize: 34, fontWeight: FontWeight.bold, letterSpacing: 1.5)),
                      ...
                      child: const Row(
                        ...
                        children: [
                          ...
                          Text('Powered by Gemini AI',
                              style: TextStyle(color: AppConstants.goldColor, fontSize: 13, fontWeight: FontWeight.w600)),
                        ],
                      ),
                    ),
                  ],
                ...
                child: Column(
                  children: [
                    Text('Experience jewellery\nlike never before',
                        ...
                        style: GoogleFonts.playfairDisplay(fontSize: 22, fontWeight: FontWeight.bold, color: AppConstants.deepPurple, height: 1.3)),
                    const SizedBox(height: 10),
                    Text('Select a piece, snap a selfie, and see yourself\nadorned with stunning jewellery — instantly.',
                        textAlign: TextAlign.center,
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: const Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text('Start TryOn', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, letterSpacing: 0.8)),
                            SizedBox(width: 10),
      ...
      Stack(clipBehavior: Clip.none, children: [
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Center(child: Text(step, style: const TextStyle(fontSize: 10, color: Colors.white, fontWeight: FontWeight.bold))),
          ),
        ),
      ]),
